...
// error building on linux http://stackoverflow.com/questions/16645040/cant-read-dds-image-header-on-linux
// for dds file structures
#if defined(WIN32)
#define DDS_LONG long
#else
#define DDS_LONG int
#endif
...
{
    unsigned DDS_LONG dwSize;
    unsigned DDS_LONG dwFlags;
    unsigned DDS_LONG dwFourCC;
    unsigned DDS_LONG dwRGBBitCount;
    unsigned DDS_LONG dwRBitMask;
    unsigned DDS_LONG dwGBitMask;
    unsigned DDS_LONG dwBBitMask;
    unsigned DDS_LONG dwABitMask;
};
...
struct DDS_HEADER
{
    ...
    unsigned DDS_LONG dwSize;
    unsigned DDS_LONG dwFlags;
    unsigned DDS_LONG dwHeight;
    unsigned DDS_LONG dwWidth;
    unsigned DDS_LONG dwPitchOrLinearSize;
    unsigned DDS_LONG dwDepth;
    unsigned DDS_LONG dwMipMapCount;
    unsigned DDS_LONG dwReserved1[11];
    DDS_PIXELFORMAT ddspf;
    unsigned DDS_LONG dwCaps1;
    unsigned DDS_LONG dwCaps2;
    unsigned DDS_LONG dwReserved2[3];
};

static_assert(sizeof(DDS_HEADER) == 124, "size of DDS_HEADER must exactly be 124 as per the file specification");
